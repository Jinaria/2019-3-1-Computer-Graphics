...
def createVertexAndIndexArraySeparate():
    varr = np.array([
...
def main():
    ...
    if not glfw.init():
        return
    window = glfw.create_window(480,480,'2014005187-8-2', None,None)
    if not window:
        glfw.terminate()
        return
    ...
    gVertexArraySeparate, gIndexArraySeparate = createVertexAndIndexArraySeparate()
